...
class OurDatabase{
  ...
  Future<String> createUser(OurUser user) async{
    ...
    try{
      ...
      // await FirebaseFirestore.instance.collection("usersPhone").doc("phone").set({
      //   'phones': user.phone
      // });
      retVal = "success";
    } catch (e) {
              ...
              if(element.id == id) {
                ...
                _data.add(OurGarage(
                  ...
                  images: ImagesModel(
                    ...
                    profileImages: data["shopImages"]["profile"],
                  ),
  ...
  Future<List<OurGarage>> fetchIds(String vehicle, String brand) async{
    ...
    var result = await FirebaseFirestore.instance
      ...
      if(vehicle!="rickshaw" && vehicle!="truck" && vehicle!="cycle" && vehicle!="printer"  && vehicle!= "television" &&  vehicle!= "water purifier"  && vehicle!= "refrigerator"  && vehicle!="ac"  && vehicle!= "washing machine"  && vehicle!= "microwave"  && vehicle!= "chimney" && vehicle!= "watch" && vehicle != "grinder" && vehicle!= "invertor") {
        ...
        print(value.get("shops"));
        _data = value.get("shops");
        //_data.forEach((element) {_firestore.collection(collectionPath).doc(element).})
        if(_data.isNotEmpty) {
          garages = await fetchGarages(_data);
        }
