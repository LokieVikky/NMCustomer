import 'package:namma_mechanics/pages/Sidebar/SideDrawer.dart';
...
class AboutUs extends StatelessWidget {
  ...
  var dt =
      'The namma_mechanics team worked hard to develop this app. This app helps the customer to find nearby mechanics, and garages/service centers. We constantly improve the products and are determined with your moral to provide 100% transparency to the user. We are dedicated hours & hours to improve the products so that you could use the product effortlessly. ';
  @override
