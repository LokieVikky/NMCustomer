...
import 'package:namma_mechanics/pages/Usage/widgets/Usage_checkbox.dart';
...
import 'package:namma_mechanics/pages/subPages/widgets/mechanicListTile/vehiclesServices.dart';
import 'package:namma_mechanics/data/data.dart';
import 'package:namma_mechanics/pages/Usage/widgets/CustomButton.dart';
import 'package:namma_mechanics/pages/Report/Report.dart';
import 'package:namma_mechanics/pages/Usage/widgets/Usage_checkbox.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FlatButton(
        ...
        padding: EdgeInsets.all(20.0),
        onPressed: () {
          _instance.orderData = fullDetails.allData;
